...
class Dashboard extends StatelessWidget {
  ...
  static const Color backgroundColor = Color(0xFF420309);
...
class PageOne extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _SimplePage(title: 'The Appointments');
}
...
class PageTwo extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _SimplePage(title: 'The Packages');
}
...
class PageThree extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _SimplePage(title: 'The Reader');
}
...
class PageFour extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) =>
      const _SimplePage(title: 'The Testimonies');
}
